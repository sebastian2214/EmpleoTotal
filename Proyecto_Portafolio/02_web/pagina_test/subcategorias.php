...
try {
    ...
    try {
        ...
        if (isset($_POST['buscar']) && !empty($_POST['buscar'])) {
            ...
            $sql = "SELECT * FROM sub_cat WHERE id_sub_cat LIKE :buscar OR nombre_sub_cat LIKE :buscar";
            $stmt = $base_de_datos->prepare($sql);
            ...
            $stmtCategorias = $base_de_datos->query($sqlCategorias);
...
<head>
    ...
    <link rel="stylesheet" href="./subcategorias/subcategorias.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
    <title>Listado de SubCategorias</title>
</head>
<body>
<header class="inicio-header">
    ...
    <h3 class="text-center mb-8">Buscar SubCategorias</h3>

    <form class="mb-4" method="POST" action="">
        <div class="mb-2">
            <input type="text" class="form-control" name="buscar" placeholder="Buscar SubCategorias" value="<?php echo htmlspecialchars($buscar); ?>" aria-label="Buscar SubCategorias">
        </div>
        <div class="d-grid">
        ...
        <table class="table table-bordered table-striped table-hover">
            ...
            <tbody>
                <?php while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) { 
                    ...
                    $stmtCategoriaNombre = $base_de_datos->prepare($sqlCategoriaNombre);
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <script src=".//subcategorias/subcategorias.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"></script>
